  ...
  <div class="register-box">
    ...
    <?php
      if($this->session->flashdata('duplikat')){
        ?>
      <div class="alert alert-danger text-center text-center">
    ...
    <div class="row">
     <div class="col-xs-6">
       <a href="<?=base_url()?>" class="btn btn-success btn-block btn-flat">Kembali Ke Login</a>
      </div>
      <!-- /.col -->
      <div class="col-xs-6">
